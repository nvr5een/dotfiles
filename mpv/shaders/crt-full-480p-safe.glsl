//!HOOK MAIN
//!BIND HOOKED
//!DESC CRT Full 480p: source-space bloom and warm phosphor response
...
vec4 hook() {
    ...
    float glow = smoothstep(0.58, 1.0, peak);
    vec3 rgb = base + mix(base, blur, 0.55) * glow * 0.27;
    rgb *= vec3(1.045, 1.015, 0.955);
    return vec4(clamp(rgb, 0.0, 1.0), 1.0);
}

//!HOOK OUTPUT
//!BIND HOOKED
//!DESC CRT Full 480p: strong 480-line texture and display-locked grille

#define PI 3.14159265358979323846
#define CRT_ROWS 480.0
#define SCAN_STRENGTH 0.38
#define MASK_AMOUNT 0.11
