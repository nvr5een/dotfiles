//!HOOK OUTPUT
//!BIND HOOKED
//!DESC CRT Lite 1080p: gentle 720-line texture and display-locked grille

#define PI 3.14159265358979323846
#define CRT_ROWS 720.0
#define SCAN_STRENGTH 0.17
#define MASK_AMOUNT 0.050
...
vec4 hook() {
    ...
    rgb *= mask;
    rgb = pow(clamp(rgb * 1.030 + 0.007, 0.0, 1.0), vec3(0.982));
    rgb *= vec3(1.022, 1.008, 0.978);
